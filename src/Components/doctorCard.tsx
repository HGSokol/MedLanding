  ...
  return (
    <div className="relative group/doc flex flex-col gap-[18rem]">
      ...
      <div
        ...
        className="bottom-0 opacity-0 group-hover/doc:opacity-100 cursor-pointer duration-200 bg-[#3563E9] hover:bg-[#1941B9] p-[20rem] h-[46rem] rounded-[8rem] text-[16rem] font-semibold leading-[160%] text-[#FFF] flex items-center justify-center"
      >
        Записаться
      </div>
    </div>
