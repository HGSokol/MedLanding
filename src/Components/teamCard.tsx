	...
	return (
		<div className="flex flex-col gap-[10rem] md:gap-[22rem]">
			...
			<div className="flex flex-col md:gap-[8rem] text-center">
				<div
					className={`text-[16rem] md:text-[18rem] font-semibold leading-[160%] ${
			...
			<div
				...
				} cursor-pointer duration-200 bg-[#3563E9] hover:bg-[#1941B9] p-[20rem] h-[38rem] md:h-[46rem] rounded-[8rem] text-[14rem] md:text-[16rem] font-semibold leading-[160%] text-[#FFF] flex items-center justify-center`}>
				Записаться
			</div>
		</div>
	);
