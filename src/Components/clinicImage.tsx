...
export default function ClinicImage() {
  ...
  return (
    <div className="">
      <div className="hidden md:flex flex-row flex-wrap gap-[8rem] md:gap-[25rem]">
      ...
      <div className="md:hidden snap-mandatory snap-x flex overflow-x-scroll flex-col flex-wrap h-[360rem] gap-x-[16rem]">
        {dataImage.map((e, i) => {
          return (
