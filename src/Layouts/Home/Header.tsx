...
export default function Header() {
	const { activePopup, setActivePopup, setFixedHeader } = useContext(AppContext);
	...
	return (
		<>
			<header
				ref={headerRef}
				className="duration-[200rem] fixed z-[100] flex flex-row px-[16rem] md:px-[95rem] h-[78rem] md:h-[102rem] justify-between items-center w-[100%]">
				<div
			...
			<div
				className={`relative flex flex-row px-[16rem] md:px-[95rem] h-[78rem] md:h-[102rem] justify-between items-center w-[100%]`}></div>
		</>
	);
}
