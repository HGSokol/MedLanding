  ...
  return (
    <div className="font-mont flex flex-col min-h-[100dvh] bg-[#EDF0F4]">
      ...
      <main className="grow-[3]">
        <Breadcrumbs />
        <DoctorsTitle />
        <div className="px-[16rem] mb-[50rem] md:mb-[0rem] md:px-[95rem] flex flex-col md:flex-row md:justify-between">
          <div className="min-h-[50rem] snap-mandatory snap-x md:px-[95rem] md:mb-[60rem] flex flex-row overflow-scroll  gap-[10rem] ">
            {dataTabs.map((e, i) => {
